...
public class PanelTaiKhoan_DoiMatKhau_SV extends JPanel {
	...
	public PanelTaiKhoan_DoiMatKhau_SV() {
...
//      jTextField_MatKhauCu.addActionListener(new SuKienThoiGianThi(this));
...
//      jTextField_MatKhauMoi.addActionListener(new SuKienThoiGianThi(this));
		...
		nutpanelLuu.addMouseListener(new suKienPanelTaiKhoan_DoiMatKhau_SV(this));
