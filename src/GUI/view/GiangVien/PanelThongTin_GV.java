...
import javax.swing.border.LineBorder;
	...
	public class PanelThongTin_GV extends JPanel {
		...
		private void caiDatPanelThongTin() {
			...
			tableCuaTui.addMouseListener(new SuKienPannelThongTin_GV(this));
			
			
			jScrollPaneTable = new JScrollPane();
			jScrollPaneTable.setBounds(10, 61, 940, 628);
