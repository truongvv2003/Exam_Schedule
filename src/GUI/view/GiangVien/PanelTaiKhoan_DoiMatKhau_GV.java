...
public class PanelTaiKhoan_DoiMatKhau_GV extends JPanel {
	...
	public PanelTaiKhoan_DoiMatKhau_GV() {
	...
	private void caiDatPanelXepLichThi_ThoiGianThi() {
		...
		nutpanelLuu.addMouseListener(new SuKienPanelTaiKhoan_DoiMatKhau_GV(this));
