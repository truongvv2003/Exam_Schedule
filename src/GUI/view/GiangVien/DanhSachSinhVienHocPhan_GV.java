...
public class DanhSachSinhVienHocPhan_GV extends JFrame {
	...
	public DanhSachSinhVienHocPhan_GV() {
		setUndecorated(true);
		setResizable(false);
	...
	private void caiDatPanelDanhSachSinhVienHocPhan() {
		...
		this.addComponentListener(new SuKienPannelThongTin_GV(this));
		...
		lblExit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				DanhSachSinhVienHocPhan_GV.this.dispose();
			}
			// di chuyển chuột vào
			@Override
		...
		this.addWindowFocusListener(new SuKienPannelThongTin_GV(this));
