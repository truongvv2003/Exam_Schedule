...
public class SuKienDoiHoatAnhTrenMenu extends WindowAdapter implements MouseListener, MouseMotionListener{
	...
	public void mouseClicked(MouseEvent e) {
		...
		//panel
		if(e.getSource() == this.manHinhChinh.paneHome) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelHome);
		}
		
		if(e.getSource() == this.manHinhChinh.paneThongTin) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelThongTin);
		}
		
		if(e.getSource() == this.manHinhChinh.paneXepLichThi) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelXepLichThi);
		}
		...
		//lbl text
		if(e.getSource() == this.manHinhChinh.lblHome) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelHome);
		}
		
		if(e.getSource() == this.manHinhChinh.lblThongTin) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelThongTin);
		}
		
		if(e.getSource() == this.manHinhChinh.lblXepLichThi) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelXepLichThi);
		}
		...
		//lbl icon
		if(e.getSource() == this.manHinhChinh.lblIconHome) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelHome);
		}
	
		if(e.getSource() == this.manHinhChinh.lblIconThongTin) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelThongTin);
		}
		
		if(e.getSource() == this.manHinhChinh.lblIconXepLichThi) {
			this.manHinhChinh.form_DuocChon(this.manHinhChinh.panelXepLichThi);
		}
