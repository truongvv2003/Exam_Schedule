...
public class SuKienPanelTaiKhoan_DoiMatKhau implements MouseListener{
	PanelTaiKhoan_DoiMatKhau panelTaiKhoan_DoiMatKhau;
	...
	public void suKienDoiMatKhau() {
		if(this.panelTaiKhoan_DoiMatKhau.jTextField_MatKhauCu.getText().equals(ManHinhChinh.matKhauAdmin) == false) {
			...
			UserBLL.getInstance().saveAdmin(ManHinhChinh.taiKhoanAdmin, this.panelTaiKhoan_DoiMatKhau.jTextField_MatKhauMoi.getText());
