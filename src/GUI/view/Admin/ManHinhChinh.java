...
public class ManHinhChinh extends JFrame {
	...
	public PanelXepLichThi panelXepLichThi;
	...
	public static ManHinhChinh getManHinhChinh()
	{
		if(manHinhChinh == null)
		{
			manHinhChinh = new ManHinhChinh();
		}
		return manHinhChinh;
	}
	...
	public void caiDatGiaoDien() {
		...
		panelXepLichThi = new PanelXepLichThi();
		...
		lblIconLogo.setIcon(new ImageIcon(ManHinhChinh.class.getResource("/res/university.png")));
		lblIconLogo.setBounds(22, 10, 264, 200);
		paneMenu.add(lblIconLogo);
		
		// sự kiện đổi hoạt ảnh trên menu
		paneHome = new JPanel();
		paneHome.addMouseListener(new SuKienDoiHoatAnhTrenMenu(this, paneHome));
		...
		lblIconHome.setIcon(new ImageIcon(ManHinhChinh.class.getResource("/res/Home.png")));
		lblIconHome.setBounds(10, -2, 76, 76);
		paneHome.add(lblIconHome);
		
		paneThongTin = new JPanel();
		paneThongTin.addMouseListener(new SuKienDoiHoatAnhTrenMenu(this, paneThongTin));
		...
		paneXepLichThi.addMouseListener(new SuKienDoiHoatAnhTrenMenu(this, paneXepLichThi));
