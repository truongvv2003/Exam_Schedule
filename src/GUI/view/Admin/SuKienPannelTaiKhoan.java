...
public class SuKienPannelTaiKhoan implements MouseListener{
	...
	public void form_DuocChon(JPanel panel) {
		panelTaiKhoan.panelTaiKhoan_TraCuuTaiKhoan.setVisible(false);
	...
	public void mousePressed(MouseEvent e) {
		...
		if(e.getSource() == this.panelTaiKhoan.nutpanelTraCuuTaiKhoan)
		{
			this.form_DuocChon(this.panelTaiKhoan.panelTaiKhoan_TraCuuTaiKhoan);
		}
	}
